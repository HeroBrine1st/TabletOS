...
local function prepareToUpdate(filelist)
	...
	thread.create(function()
		...
		for i = 1, #filelist do
			...
			core.log(2,"Updater",serialization.serialize(file))
			request({
				url = file.url,
			},function(data)
...
core.log(2,"Updater",serialization.serialize(updates))
if updates then
	print("Updates got #2")
